...
export const SidebarFooter: React.FC = () => {
    ...
    return (
        <>
            ...
            {isLogoutModalOpen && ReactDOM.createPortal(
                <div className="fixed inset-0 z-[200] flex items-center justify-center">
                    ...
                    />
                    {/* Modal card */}
                    <div className="relative z-10 w-[340px] bg-white dark:bg-surface-a0 rounded-2xl shadow-2xl border border-slate-100 dark:border-surface-a10 p-6 flex flex-col items-center gap-5">
                        <div className="w-12 h-12 rounded-full bg-red-50 dark:bg-red-900/20 flex items-center justify-center">
                            <LogOut className="w-6 h-6 text-red-500" />
                        </div>
                        <div className="text-center">
                            <h3 className="text-base font-bold text-slate-800 dark:text-white">Sign out?</h3>
                            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">You'll need to log back in to continue planning.</p>
                        </div>
            ...
            <div ref={containerRef} className="p-2 border-t border-slate-100 dark:border-surface-a10 bg-white dark:bg-surface-a0 relative transition-colors duration-200">
                ...
                <div className={cn(
                    ...
                    <div className="p-2 space-y-1">
                        ...
                        <div className="px-3 py-2 mb-2 bg-slate-50 dark:bg-surface-a10 rounded-lg flex items-center justify-center">
                            <p className="text-xs font-medium text-slate-900 dark:text-white truncate text-center">{email}</p>
                        </div>
                    </div>
